...
public class VisualListElement : VisualElement
{
    ...
    protected virtual void OnEnable()
    {
        if (IsDraggable)
        {
            Draggable.DragStarted += Draggable_DragStarted;
            Draggable.DragEnded += Draggable_DragEnded;
        }
    }
    ...
    private void Draggable_DragEnded(object arg1, PointerEventData data)
    {
        _dragged = false;
        _shouldRefresh = true;
    }

    private void Draggable_DragStarted(object arg1, PointerEventData data)
    {
        _dragged = true;
        _shouldRefresh = true;
    }
