...
namespace OneStopShop
{
    public sealed class BoardDropAdapter : IDisposable
    {
        ...
        private void CreatePreview()
        {
            ...
            {
                BoardPlacementType.Create => placement.CurrentPlacement.Definition,
                BoardPlacementType.Move => placement.CurrentPlacement.Piece.Definition,
                BoardPlacementType.None => null,
